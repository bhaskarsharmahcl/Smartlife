...
function send() {
 ...
 function chatBotAppend(text,user,type,message)
 {
      if(user=="user"){
        //  alert("text");
          $("#chat-msg-board").append("<div class='row msg_container base_sent'><div class='col-md-10 col-xs-10'><div class='messages msg_sent'><p>" + text + "</p></div></div><div class='col-md-2 col-xs-2 avatar'><img src='/scripts/chatBot/img/img.jpg' class='img-responsive '></div> </div>");

      }

      if(user=="bot" && type=="error"){
          $("#chat-msg-board").append("<div class='row msg_container base_receive'><div class='col-md-2 col-xs-2 avatar'><img src='/scripts/Chatbot/img/dxm.png' class='img-responsive '></div><div class='col-md-10 col-xs-10'><div class='messages msg_receive'><p>" + message + "</p></div></div> </div>");
      }  

      if(user=="bot" && type=="text"){
          $("#chat-msg-board").append("<div class='row msg_container base_receive'><div class='col-md-2 col-xs-2 avatar'><img src='/scripts/Chatbot/img/dxm.png' class='img-responsive '></div><div class='col-md-10 col-xs-10'><div class='messages msg_receive'><p>" + message.text + "</p></div></div> </div>");
      }
      ...
      if(user=="bot" && type=="attachment-generic"){
         // alert("hi");
          ...
          $("#chat-msg-board").append("<div class='row msg_container base_receive'><div class='col-md-2 col-xs-2 avatar'><img src='/scripts/Chatbot/img/dxm.png' class='img-responsive '></div><div class='col-md-10 col-xs-10'><div class='messages msg_receive'>Here are suggestions for you</div></div> </div>");
      ...
      if(user=="bot" && type=="attachment"){
          		var btnBody='<hr/>';
       			 ...
       			 $("#chat-msg-board").append("<div class='row msg_container base_receive'><div class='col-md-2 col-xs-2 avatar'><img src='/scripts/Chatbot/img/dxm.png' class='img-responsive '></div><div class='col-md-10 col-xs-10'><div class='messages msg_receive'><p>" + message.attachment.payload.text + "</p>" + btnBody + "</div></div> </div>");
        }  
